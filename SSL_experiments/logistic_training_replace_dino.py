...
wandb.init(project="logistic-regression-SSL", entity="apd_stats", resume="allow", 
           name=f"{current_datetime}_dino_replace")

# Load the pre-saved features and labels
train_features = torch.load('/scratch/users/apd1995/SSL_checkpoints/checkpoints/train/imagenet_resnet50_dino_2023-06-06_13-59-48.ckpt_train_features.pt')
train_labels = torch.load('/scratch/users/apd1995/SSL_checkpoints/checkpoints/train/imagenet_resnet50_dino_2023-06-06_13-59-48.ckpt_train_labels.pt')
test_features = torch.load('/scratch/users/apd1995/SSL_checkpoints/checkpoints/test/imagenet_resnet50_dino_2023-06-06_13-59-48.ckpt_test_features.pt')
test_labels = torch.load('/scratch/users/apd1995/SSL_checkpoints/checkpoints/test/imagenet_resnet50_dino_2023-06-06_13-59-48.ckpt_test_labels.pt')
