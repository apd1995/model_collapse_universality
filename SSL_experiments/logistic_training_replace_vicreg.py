...
# -*- coding: utf-8 -*-
"""
Modified logistic regression training script
"""
...
wandb.init(project="logistic-regression-SSL", entity="apd_stats", resume="allow", 
           name=f"{current_datetime}_vicreg_replace")

# Load the pre-saved features and labels
train_features = torch.load('/scratch/users/apd1995/SSL_checkpoints/checkpoints/train/imagenet_resnet50_vicreg_2023-09-11_10-53-08.ckpt_train_features.pt')
train_labels = torch.load('/scratch/users/apd1995/SSL_checkpoints/checkpoints/train/imagenet_resnet50_vicreg_2023-09-11_10-53-08.ckpt_train_labels.pt')
test_features = torch.load('/scratch/users/apd1995/SSL_checkpoints/checkpoints/test/imagenet_resnet50_vicreg_2023-09-11_10-53-08.ckpt_test_features.pt')
test_labels = torch.load('/scratch/users/apd1995/SSL_checkpoints/checkpoints/test/imagenet_resnet50_vicreg_2023-09-11_10-53-08.ckpt_test_labels.pt')
...
for iteration in range(num_iterations):
    ...
    # Replace new labels and features
    ...
    train_dataset = TensorDataset(new_train_features, new_train_labels)
    train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True)
