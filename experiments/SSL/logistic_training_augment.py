...
wandb.init(project="logistic-regression-SSL", entity="apd_stats", resume="allow", 
           name=f"{current_datetime}_byol_augment")

# Load the pre-saved features and labels
train_features = torch.load('/scratch/users/apd1995/SSL_checkpoints/checkpoints/train/imagenet_resnet50_byol_2024-02-14_16-10-09.ckpt_train_features.pt')
train_labels = torch.load('/scratch/users/apd1995/SSL_checkpoints/checkpoints/train/imagenet_resnet50_byol_2024-02-14_16-10-09.ckpt_train_labels.pt')
test_features = torch.load('/scratch/users/apd1995/SSL_checkpoints/checkpoints/test/imagenet_resnet50_byol_2024-02-14_16-10-09.ckpt_test_features.pt')
test_labels = torch.load('/scratch/users/apd1995/SSL_checkpoints/checkpoints/test/imagenet_resnet50_byol_2024-02-14_16-10-09.ckpt_test_labels.pt')
...
for iteration in range(num_iterations):
    ...
    # Append the new features and labels to the augmented training set
    augmented_train_labels = torch.cat((augmented_train_labels, new_train_labels), dim=0)
    augmented_train_features = torch.cat((augmented_train_features, new_train_features), dim=0)
